...
// Здесь можно добавить логику для получения статистики по каждой теме
</script>
  ...
  <v-container>
    <v-row justify="center">
      <v-col cols="12" md="10" lg="8">
        <v-card>
          <v-card-title class="text-h3 text-center pa-6">
            Подготовка к интервью
            <div class="text-subtitle-1 text-medium-emphasis mt-2">
              Вопросы и ответы для технического интервью по Frontend разработке
            </div>
          </v-card-title>
          ...
          <v-card-text>
            <v-row>
              ...
              <!-- WebAPI блок -->
              <v-col cols="12" md="6">
                <v-card variant="outlined" hover class="h-100" to="/web-api/web-api-interview">
                  <v-card-text class="pa-6">
                    <div class="d-flex align-center mb-4">
                      <v-avatar color="green" size="large" class="mr-4">
                        <v-icon size="large">mdi-api</v-icon>
                      </v-avatar>
                      <div>
                        <h3 class="text-h5 mb-1">Web API</h3>
                        <p class="text-body-2 text-medium-emphasis mb-0">
                          Браузерные API
                        </p>
                      </div>
                    ...
                    <p class="text-body-2 mb-0">
                      Вопросы по работе с Blob, File, загрузке файлов, чтению данных и обработке бинарного контента.
                    </p>
                  </v-card-text>

                  <v-card-actions class="pa-6 pt-0">
                    <v-btn color="green" variant="tonal" append-icon="mdi-arrow-right">
                      Начать подготовку
                    </v-btn>
                  </v-card-actions>
                </v-card>
              ...
              <!-- TanStack Query блок -->
              <v-col cols="12" md="6">
                <v-card variant="outlined" hover class="h-100" to="/tanstack-query/ssr-next-interview">
                  <v-card-text class="pa-6">
                    <div class="d-flex align-center mb-4">
                      <v-avatar color="teal" size="large" class="mr-4">
                        <v-icon size="large">mdi-database-sync-outline</v-icon>
                      </v-avatar>
                      <div>
                        <h3 class="text-h5 mb-1">TanStack Query SSR</h3>
                        <p class="text-body-2 text-medium-emphasis mb-0">
                          Next.js App Router
                        </p>
                      </div>
                    ...
                    <div class="mb-4">
                      <v-chip color="success" size="small" class="mr-2 mb-2"> Junior: 6 </v-chip>
                      <v-chip color="warning" size="small" class="mr-2 mb-2"> Middle: 16 </v-chip>
                      <v-chip color="error" size="small" class="mr-2 mb-2"> Senior: 3 </v-chip>
                    </div>

                    <p class="text-body-2 mb-0">
                      Вопросы по prefetchQuery, dehydrate, HydrationBoundary, query keys,
                      staleTime и связке Server/Client Components.
                    </p>
                  </v-card-text>
              ...
              <v-col cols="12" md="6">
                <v-card variant="outlined" hover class="h-100" to="/web/web-interview">
                  <v-card-text class="pa-6">
                    <div class="d-flex align-center mb-4">
                      <v-avatar color="indigo" size="large" class="mr-4">
                        <v-icon size="large">mdi-web</v-icon>
                      </v-avatar>
                      <div>
                        <h3 class="text-h5 mb-1">Web</h3>
                        <p class="text-body-2 text-medium-emphasis mb-0">
                          Веб-технологии
                        </p>
                      </div>
                    ...
                    <div class="mb-4">
                      <v-chip color="success" size="small" class="mr-2 mb-2"> Junior: 4 </v-chip>
                      <v-chip color="warning" size="small" class="mr-2 mb-2"> Middle: 8 </v-chip>
                      <v-chip color="error" size="small" class="mr-2 mb-2"> Senior: 3 </v-chip>
                    </div>

                    <p class="text-body-2 mb-0">
                      Вопросы по протоколу HTTP, методам запросов, заголовкам, статусам, кэшированию и безопасности.
                    </p>
                  </v-card-text>

                  <v-card-actions class="pa-6 pt-0">
                    <v-btn color="indigo" variant="tonal" append-icon="mdi-arrow-right">
                      Начать подготовку
                    </v-btn>
                  </v-card-actions>
                </v-card>
              ...
              <!-- блок Testing -->
              <v-col cols="12" md="6">
                <v-card variant="outlined" hover class="h-100" to="/testing/testing-interview">
                  <v-card-text class="pa-6">
                    <div class="d-flex align-center mb-4">
                      <v-avatar color="deep-purple" size="large" class="mr-4">
                        <v-icon size="large">mdi-flask</v-icon>
                      </v-avatar>
                      <div>
                        <h3 class="text-h5 mb-1">Testing</h3>
                        <p class="text-body-2 text-medium-emphasis mb-0">
                          Тестирование ПО
                        </p>
                      </div>
                    ...
                    <div class="mb-4">
                      <v-chip color="success" size="small" class="mr-2 mb-2"> Junior: 2 </v-chip>
                      <v-chip color="warning" size="small" class="mr-2 mb-2"> Middle: 7 </v-chip>
                      <v-chip color="error" size="small" class="mr-2 mb-2"> Senior: 6 </v-chip>
                    </div>

                    <p class="text-body-2 mb-0">
                      Вопросы о видах тестирования, TDD, пирамиде тестирования, unit/integration/E2E тестах и эффективности тестирования.
                    </p>
                  </v-card-text>

                  <v-card-actions class="pa-6 pt-0">
                    <v-btn color="deep-purple" variant="tonal" append-icon="mdi-arrow-right">
                      Начать подготовку
                    </v-btn>
                  </v-card-actions>
                </v-card>
